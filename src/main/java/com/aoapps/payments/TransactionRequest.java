...
public class TransactionRequest implements Cloneable {
  ...
  public void setCurrency(Currency currency) {
    ...
    if (taxAmount != null) {
      taxAmount = taxAmount.setScale(scale);
    }
    if (shippingAmount != null) {
      shippingAmount = shippingAmount.setScale(scale);
    }
    if (dutyAmount != null) {
      dutyAmount = dutyAmount.setScale(scale);
    }
  }
  ...
  public void setAmount(BigDecimal amount) throws IllegalArgumentException {
    if (amount == null) {
      ...
      if (amount.compareTo(BigDecimal.ZERO) <= 0) {
        throw new LocalizedIllegalArgumentException(PACKAGE_RESOURCES, "TransactionRequest.setAmount.amount.lessThanEqualZero");
      }
      try {
  ...
  public void setShippingCountryCode(String shippingCountryCode) {
    if (shippingCountryCode == null) {
      ...
      if (shippingCountryCode.length() != 2) {
        throw new LocalizedIllegalArgumentException(PACKAGE_RESOURCES, "TransactionRequest.setShippingCountryCode.shippingCountryCode.mustBe2Digits");
      }
  ...
  public void setMerchantEmail(String merchantEmail) {
    if (merchantEmail == null) {
      ...
      if (!GenericValidator.isEmail(merchantEmail)) {
        throw new LocalizedIllegalArgumentException(PACKAGE_RESOURCES, "TransactionRequest.setMerchantEmail.merchantEmail.invalid");
      }
