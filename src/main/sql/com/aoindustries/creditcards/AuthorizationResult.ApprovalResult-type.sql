 ...
 */
CREATE TYPE "com.aoindustries.creditcards"."AuthorizationResult.ApprovalResult" AS ENUM (
  'APPROVED',
  'DECLINED',
  'HOLD'
);
COMMENT ON TYPE "com.aoindustries.creditcards"."AuthorizationResult.ApprovalResult" IS
