 ...
 */
CREATE TYPE "com.aoindustries.creditcards"."TransactionResult.CommunicationResult" AS ENUM (
  'LOCAL_ERROR',
  'IO_ERROR',
  'GATEWAY_ERROR',
  'SUCCESS'
);
COMMENT ON TYPE "com.aoindustries.creditcards"."TransactionResult.CommunicationResult" IS
