 ...
 */
CREATE TYPE "com.aoindustries.creditcards"."AuthorizationResult.ReviewReason" AS ENUM (
  'RISK_MANAGEMENT',
  'ACCEPTED_MERCHANT_REVIEW',
  'ACCEPTED_AUTHORIZED_MERCHANT_REVIEW'
);
COMMENT ON TYPE "com.aoindustries.creditcards"."AuthorizationResult.ReviewReason" IS
