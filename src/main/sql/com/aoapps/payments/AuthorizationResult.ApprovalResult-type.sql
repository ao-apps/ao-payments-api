 ...
 */
CREATE TYPE "com.aoapps.payments"."AuthorizationResult.ApprovalResult" AS ENUM (
  'APPROVED',
  'DECLINED',
  'HOLD'
);
COMMENT ON TYPE "com.aoapps.payments"."AuthorizationResult.ApprovalResult" IS
'Matches enum com.aoapps.payments.AuthorizationResult.ApprovalResult';
