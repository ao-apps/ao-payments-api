 ...
 */
CREATE TYPE "com.aoapps.payments"."AuthorizationResult.CvvResult" AS ENUM (
  'MATCH',
  'NO_MATCH',
  'NOT_PROCESSED',
...
COMMENT ON TYPE "com.aoapps.payments"."AuthorizationResult.CvvResult" IS
'Matches enum com.aoapps.payments.AuthorizationResult.CvvResult';
