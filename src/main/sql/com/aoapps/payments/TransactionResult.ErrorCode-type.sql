 ...
 */
CREATE TYPE "com.aoapps.payments"."TransactionResult.ErrorCode" AS ENUM (
  -- ALL
  'UNKNOWN',
  -- LOCAL_ERROR
  'HASH_CHECK_FAILED',
...
COMMENT ON TYPE "com.aoapps.payments"."TransactionResult.ErrorCode" IS
'Matches enum com.aoapps.payments.TransactionResult.ErrorCode';
