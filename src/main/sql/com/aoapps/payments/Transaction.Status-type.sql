 ...
 */
CREATE TYPE "com.aoapps.payments"."Transaction.Status" AS ENUM (
  'PROCESSING',
  'LOCAL_ERROR',
  'IO_ERROR',
  'GATEWAY_ERROR',
...
COMMENT ON TYPE "com.aoapps.payments"."Transaction.Status" IS
'Matches enum com.aoapps.payments.Transaction.Status';
