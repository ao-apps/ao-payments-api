 ...
 */
CREATE TYPE "com.aoapps.payments"."TransactionResult.CommunicationResult" AS ENUM (
  'LOCAL_ERROR',
  'IO_ERROR',
  'GATEWAY_ERROR',
  'SUCCESS'
);
COMMENT ON TYPE "com.aoapps.payments"."TransactionResult.CommunicationResult" IS
'Matches enum com.aoapps.payments.TransactionResult.CommunicationResult';
